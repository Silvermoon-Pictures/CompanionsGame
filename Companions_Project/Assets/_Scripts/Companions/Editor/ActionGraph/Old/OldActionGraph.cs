...
public class OldActionGraph : EditorWindow
{
    ...
    public static void ShowWindow(ActionAsset actionAsset)
    {
        ...
        OldActionGraph window = GetWindow<OldActionGraph>("Action Graph");
    ...
    private void AddToChain(EventNodeType eventNodeType, ActionGraphNode node)
    {
        ...
        nodeChains[eventNodeType].Add(node);
    }
    ...
    private void LoadGraphData()
    {
        ...
        {
            CreateEventNode("Start", new Vector2(160, 400));
        }
    ...
    private void CreateEventNode(string title, Vector2 position)
    {
        GUIStyle titleStyle = new()
        {
